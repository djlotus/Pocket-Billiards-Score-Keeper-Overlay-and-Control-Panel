const flagImageLocation = "flags/";
// - - - - - - - - - - - - - - - - - - - -
// Get Country Code for Players
// - - - - - - - - - - - - - - - - - - - -
...
function getCountryFlag(country) {
   ...
   // Check if the country code exists in the flag map
...
function populateWebStorage() {
   ...
   localStorage.setItem("playerTwoMatchScore", null);
   localStorage.setItem("matchDiscipline", null);
   localStorage.setItem("matchRatingSystem", null);
   localStorage.setItem("matchType", null);
   localStorage.setItem("matchRace", null);
   localStorage.setItem("matchPlayerOneTarget", null);
   localStorage.setItem("matchPlayer2Target", null);
   localStorage.setItem("matchStatus", null);
}
populateWebStorage();
